...
describe("buildDashboardStats", () => {
  it("builds today pace from real completion times, statuses, and due dates", () => {
    ...
    const tasks = [
      makeTask({ id: "completed-today", status: "done", completedAt: "2026-08-02T09:30:00.000Z", dueDate: "2026-08-01" }),
  ...
  it("keeps today pace independent from the selected dashboard activity range", () => {
    ...
    const tasks = [
      ...
      makeTask({ id: "older-in-progress", status: "in_progress", dueDate: "2026-08-10", createdAt: "2026-07-20T08:00:00.000Z" }),
    ];
